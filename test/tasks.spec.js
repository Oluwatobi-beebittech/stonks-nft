const { deployTestContract, getTestWallet } = require("./test-helper");
const { waffle, run } = require("hardhat");
...
describe("tasks", () => {
  ...
  describe("mint-nft", () => {
    beforeEach(async () => {
      const deployedContract = await deployTestContract("StonksNFT");
      process.env.CONTRACT_ADDRESS = deployedContract.address;
    });
